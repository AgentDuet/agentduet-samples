...
TOOL_SCHEMAS = [
    {
        "toolSpec": {
            ...
            "description": (
                "Look up a recent VibeRider ride for a rider or driver reporting a trip. "
                "Use after the caller describes pickup, dropoff, or ride id. "
                "Ride ids look like VR88421 (spoken as V R eight eight four two one)."
            ),
            "inputSchema": {
                "json": json.dumps(
                    {
                        ...
                        "properties": {
                            "ride_id": {
                                "type": "string",
                                "description": "VibeRider ride id like VR88421",
                            },
                            "pickup_hint": {
                                "type": "string",
                ...
                "json": json.dumps(
                    {
                        ...
                        "properties": {
                            ...
                            "ride_id": {
                                "type": "string",
                                "description": "Confirmed VibeRider ride id",
                            },
                            "item_description": {
                                "type": "string",
        ...
        if not matches:
            ...
            return {
                ...
                "message": (
                    ...
                    + hint
                    + " Ask for pickup, dropoff, or the ride id again as V R plus the numbers."
                ),
                "agent_speak_summary": (
                    "I could not find that ride. Please tell me the pickup and dropoff, "
                    "or say the ride id as V R, then the numbers."
                ),
            }
    ...
    def _register_case(self, args: dict) -> dict[str, Any]:
        ...
        if case_type == "lost":
            speak = (
                ...
                "Thank you for calling VibeRider Resolve."
            )
        else:
